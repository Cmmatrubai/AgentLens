...
contextBridge.exposeInMainWorld(
  "agentlens",
  Object.freeze({
    liveChecksRead: (id) => ipcRenderer.invoke("agentlens:live-checks-read", { id }),
    liveChecksStart: (id, check) => ipcRenderer.invoke("agentlens:live-checks-start", { id, check }),
    liveChecksStop: (id) => ipcRenderer.invoke("agentlens:live-checks-stop", { id }),
    liveChecksAcknowledge: (id, confirmed) => ipcRenderer.invoke("agentlens:live-checks-acknowledge", { id, confirmed }),
    liveModels: () => ipcRenderer.invoke("agentlens:live-models"),
    liveChooseProject: () => ipcRenderer.invoke("agentlens:live-choose-project"),
    ...
    liveStop: (id, key) => ipcRenderer.invoke("agentlens:live-stop", { id, key }),
    liveOpenComparison: (id) => ipcRenderer.invoke("agentlens:live-open-comparison", { id }),
    liveAcknowledgeCleanup: (id, acknowledged) => ipcRenderer.invoke("agentlens:live-acknowledge-cleanup", { id, acknowledged }),
    ...
    openInsightPair: (input) => ipcRenderer.invoke("agentlens:insight-open-pair", input),
