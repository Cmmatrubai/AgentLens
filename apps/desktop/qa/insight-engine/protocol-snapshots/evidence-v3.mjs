// Frozen balanced-evidence-v3 from 75922c9 for historical semantic suites only.
// Production code must use server/insights/evidence.mjs.
import { createHash } from "node:crypto";
import { INSIGHT_VERSION } from "../../../server/insights/schema.mjs";

export { INSIGHT_VERSION, validateInsightOutput } from "../../../server/insights/schema.mjs";
